...
#include <linux/i2c/rtxxxx.h> /* TODO: common location for i2c and slimbus */
...
struct rt5647_priv {
	...
	struct rtxxxx_platform_data *pdata;
	struct snd_soc_jack *jack;
	struct switch_dev sdev;
	struct work_struct	hp_event_work;
	struct workqueue_struct	*rt5647_workqueue;
	int hp_jd_irq;
