...
#if 1
	/* ASRC: ASRC_RATE1=SAMPLE_RETE_1, ASRC_RATE2=ASYNC_SAMPLE_RATE_1 for BT */
	regmap_update_bits(arizona->regmap, ARIZONA_ASRC_RATE1,
				  ARIZONA_AIF1_RATE_MASK, SAMPLE_RATE_1<<ARIZONA_AIF1_RATE_SHIFT);
	regmap_update_bits(arizona->regmap, ARIZONA_ASRC_RATE2,
				  ARIZONA_AIF1_RATE_MASK, ASYNC_SAMPLE_RATE_1<<ARIZONA_AIF1_RATE_SHIFT);

	/* ISRC1 (bt-sco): FSH fixed at  SAMPLE_RATE_1, ISRC1 FSL  fixed at SAMPLE_RATE_3 */
	regmap_update_bits(arizona->regmap, ARIZONA_ISRC_1_CTRL_1,
				  ARIZONA_AIF1_RATE_MASK, SAMPLE_RATE_1<<ARIZONA_AIF1_RATE_SHIFT);
	regmap_update_bits(arizona->regmap, ARIZONA_ISRC_1_CTRL_2,
				  ARIZONA_AIF1_RATE_MASK, SAMPLE_RATE_3<<ARIZONA_AIF1_RATE_SHIFT);

	/* ISRC2 (PA): FSH fixed at  SAMPLE_RATE_2, ISRC2 FSL  fixed at SAMPLE_RATE_1 */
	regmap_update_bits(arizona->regmap, ARIZONA_ISRC_2_CTRL_1,
				  ARIZONA_AIF1_RATE_MASK, SAMPLE_RATE_2<<ARIZONA_AIF1_RATE_SHIFT);
	regmap_update_bits(arizona->regmap, ARIZONA_ISRC_2_CTRL_2,
				  ARIZONA_AIF1_RATE_MASK, SAMPLE_RATE_1<<ARIZONA_AIF1_RATE_SHIFT);

	/* Fixed IN2B at single-ended mode */
	regmap_update_bits(arizona->regmap, ARIZONA_ADC_DIGITAL_VOLUME_2L,
				  ARIZONA_IN2L_SRC_SE_MASK, 1<<ARIZONA_IN2L_SRC_SE_SHIFT);
#endif
