...
#ifndef __CORE_REGS_H
#define __CORE_REGS_H
...
static inline u64 armv8_sctlr_read(void)
{
	u64 val;
...
static inline u64 armv8_mair_read(void)
{
	u64 val;
...
static inline u64 armv8_cpuactlr_read(void)
{
	u64 val;
...
static inline u64 armv8_cpuectlr_read(void)
{
	u64 val;
	asm volatile("mrs %0, s3_1_c15_c2_1" : "=r"(val));
	return val;
}

static inline u64 armv8_l2ctlr_read(void)
{
	u64 val;
	asm volatile("mrs %0, s3_1_c11_c0_2" : "=r"(val));
	return val;
}

static inline u64 armv8_l2actlr_read(void)
{
	u64 val;
...
static inline u64 armv8_l2ectlr_read(void)
{
	u64 val;
...
static inline u64 armv8_mpidr_read(void)
{
	u64 val;
...
static inline u64 armv8_midr_read(void)
{
	u64 val;
...
static inline u64 armv8_revidr_read(void)
{
	u64 val;
