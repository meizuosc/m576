...
enum exynos7420_clks {
	...
	isp_pll = 35, cam_pll, bus0_pll, bus1_pll, cci_pll, mfc_pll, aud_pll,
	...
	wdt_apl = 140, pclk_pwm, pclk_adcif,
	/* number for g3d starts from 160 */
	g3d = 160, dout_g3d, mout_g3d,
	/* number for mmc starts from 180, dma from 183 */
	/* number for rtc starts from 185 */
	aclk_mmc0 = 180, sclk_mmc0, dout_mmc0,
	pdma0, pdma1, rtc,
	aclk_mmc1, sclk_mmc1, dout_mmc1, aclk_mmc2,
	sclk_mmc2 = 190, dout_mmc2,
	...
	aclk_acel_lh_async_si_top_133, aclk_smmu_aud, aclk_xiu_lpassx, aclk_intr,
	...
	dout_aud_cdclk, dout_sclk_slimbus, dout_sclk_uart, dout_sclk_pcm, dout_sclk_i2s,
	...
	aclk_lh_vpp1, aclk_vpp1, aclk_vpp0, d_pclk_vpp, pclk_vpp,
	pclk_cp_vpp0 = 510, pclk_cp_vpp1,
	vpp_last = 599,
	...
	/* number for mfc hevc starts from 1000 */
	aclk_mfc = 1000, pclk_mfc, aclk_hevc, pclk_hevc, dout_aclk_mfc_532,
	dout_aclk_hevc_532, dout_pclk_mfc, dout_pclk_hevc, aclk_lh_s_mfc_0,
	aclk_lh_s_mfc_1, aclk_xiu_mfc_0, aclk_xiu_mfc_1, aclk_xiu_n_async_m_mfc_0,
	aclk_xiu_n_async_m_mfc_1, aclk_cp_mfc_0, aclk_cp_mfc_1, aclk_xiu_n_async_s_mfc_0,
	aclk_xiu_n_async_s_mfc_1, pclk_xiu_n_async_mfc_0, pclk_xiu_n_async_mfc_1,
	pclk_cp_mfc_0, pclk_cp_mfc_1, aclk_lh_async_s_hevc_0, aclk_lh_async_s_hevc_1,
	aclk_noc_bus1_nrt, pclk_gpio_bus1, aclk_lh_mfc0, aclk_lh_mfc1,
	...
	gate_pclk_csis0 = 3070, gate_pclk_csis1,
	...
	gate_aclk_xiu_n_async_si_cam1 = 3130,
	...
	gate_pclk_csis2, gate_pclk_fimc_is_b_glue,

	gate_hclk_ahb2apb_bridge_is5p = 3165,
	...
	gate_sclk_isp_pwm, gate_sclk_isp_mpwm,
	...
	mout_user_mux_aclk_cam0_bnsa_690, mout_user_mux_aclk_cam0_bnsb_690,
	mout_user_mux_aclk_cam0_bnsd_690,
	mout_user_mux_aclk_cam0_csis1_174,
	mout_user_mux_aclk_cam0_3aa0_690, mout_user_mux_aclk_cam0_3aa1_468,
	...
	aclk_cam0_bnsd_690, aclk_cam0_csis1_174, aclk_cam0_3aa0_690,
	...
	axius_llisfrx_llill, axius_llisfrx_llibe,
	aclk_lli_ll_init = 3510, aclk_lli_ll_target,
	aclk_lli_be_init, aclk_lli_be_target,
	aclk_lli_svc_loc, aclk_lli_svc_rem,
	user_phyclk_lli_tx0_symbol, user_phyclk_lli_rx0_symbol,

	/* Modem common */
	aclk_xiu_modemx = 3600, aclk_combo_phy_modem_pclk,
	sclk_phy_fsys0, sclk_combo_phy_modem_26m,

	aclk_usbdrd300 = 5010, user_sclk_usbdrd300,
...
static __initdata void *exynos7420_clk_regs[] = {
	...
	EXYNOS7420_DIV_APOLLO0,
	EXYNOS7420_DIV_APOLLO1,
...
struct samsung_pll_rate_table table_aud[] = {
	{492000000U,	1, 21,	0, -32768},
	{491520000U,	1, 20,	0, 31457},
	{393216000U,	1, 33,	1, -15204},
	{0,		0, 0, 0, 0},
};
...
struct samsung_pll_rate_table table_g3d[] = {
	...
	{544000000U,	3, 68, 0, 0},
	{532000000U,	6, 133, 0, 0},
	{480000000U,	3, 120, 1, 0},
	{420000000U,	3, 105, 1, 0},
	{352000000U,	3, 88, 1, 0},
	{266000000U,	6, 133, 1, 0},
	{260000000U,	3, 65, 1, 0},
	{176000000U,	3, 88, 2, 0},
	{100000000U,	3, 100, 3, 0},
	{0,		0, 0, 0, 0},
};
...
struct samsung_pll_rate_table table_disp[] = {
	{600000000U,	1, 25, 0, 0},
	{266000000U,	6, 133, 1, 0},
	{240000000U,	6, 240, 2, 0},
	{133000000U,	6, 133, 2, 0},
	{96000000U,	6, 192, 3, 0},
	{0,		0, 0, 0, 0},
};
...
PNAME(mout_top0_aud_pll_p) = {"fin_pll", "dout_sclk_aud_pll"};
...
/* g3d block */
PNAME(mout_g3d_p) = {"g3d_pll", "usermux_bus_pll_g3d"};
/* disp block */
PNAME(mout_sub_sclk_decon_int_eclk_p) = {"usermux_sclk_decon_int_eclk", "disp_pll"};
PNAME(mout_sub_sclk_decon_int_vclk_p) = {"usermux_sclk_decon_vclk", "disp_pll"};
...
/* mif */
PNAME(mout_aclk_mif_pll_p) = {"dout_sclk_bus0_pll_mif", "mif_pll"};
...
/* fsys0 */
PNAME(sclk_combo_phy_modem) = {"fin_pll", "oscclk_26m", "dout_sclk_phy_fsys0_26m"};
...
static struct samsung_composite_pll exynos7420_pll_clks[] __refdata = {
	...
	PLL(none, "apollo_pll", pll_1451x, APOLLO_LOCK, APOLLO_CON, APOLLO_CON, 31, \
			...
			table_apollo, CLK_IGNORE_UNUSED, "mout_apollo_pll"),
	PLL(none, "mif_pll", pll_1450x, MIF_LOCK, MIF_CON, MIF_CON, 31, \
			EXYNOS7420_MUX_SEL_TOPC5, 16, \
			EXYNOS7420_MUX_STAT_TOPC5, 20, \
			table_mif, CLK_IGNORE_UNUSED, "mif_pll"),
};
...
static struct samsung_fixed_rate exynos7420_fixed_rate_clks[] __initdata = {
	...
	FRATE(none, "ioclk_i2s_clk", NULL, CLK_IS_ROOT, 50000000),
	...
	FRATE(none, "phyclk_usbhost20_phy_freeclk__hsic1", NULL, CLK_IS_ROOT, 60000000),
	FRATE(none, "phyclk_usbhost20_phy_phyclk__hsic1", NULL, CLK_IS_ROOT, 60000000),
	FRATE(none, "phyclk_lli_tx0_symbol", NULL, CLK_IS_ROOT, 150000000),
	FRATE(none, "phyclk_lli_rx0_symbol", NULL, CLK_IS_ROOT, 150000000),
	FRATE(none, "oscclk_26m", NULL, CLK_IS_ROOT, 26000000),
};
...
static struct samsung_fixed_factor exynos7420_fixed_factor_clks[] __initdata = {
	...
	FFACTOR(none, "pwm-clock", "pclk_pwm", 1, 1, CLK_SET_RATE_PARENT),
};
...
static struct samsung_composite_mux exynos7420_mux_clks[] __refdata = {
	...
	MUX(none, "mout_aclk_bus1_532", topc_group1, \
			EXYNOS7420_MUX_SEL_TOPC2, 12, 2, \
			EXYNOS7420_MUX_STAT_TOPC2, 12, 4, 0, "mout_aclk_bus1_532"),
	MUX(none, "mout_aclk_bus0_532", topc_group1, \
			EXYNOS7420_MUX_SEL_TOPC2, 8, 2, \
	...
	MUX(none, "mout_aclk_ccore_532", topc_group1, \
			EXYNOS7420_MUX_SEL_TOPC2, 0, 2, \
			EXYNOS7420_MUX_STAT_TOPC2, 0, 4, 0, "mout_aclk_ccore_532"),
	...
	MUX(none, "mout_aclk_mfc_bus_532", topc_group1, \
			EXYNOS7420_MUX_SEL_TOPC3, 16, 2, \
			EXYNOS7420_MUX_STAT_TOPC3, 16, 4, 0, "mout_aclk_mfc_bus_532"),
	MUX(none, "mout_aclk_mfc_532", topc_group1, \
			EXYNOS7420_MUX_SEL_TOPC3, 8, 2, \
			EXYNOS7420_MUX_STAT_TOPC3, 8, 4, 0, "mout_aclk_mfc_532"),
	MUX(none, "mout_aclk_g2d_266", topc_group1, \
			EXYNOS7420_MUX_SEL_TOPC3, 4, 2, \
			EXYNOS7420_MUX_STAT_TOPC3, 4, 4, 0, "mout_aclk_g2d_266"),
	MUX(none, "mout_aclk_g2d_400", topc_group1, \
			EXYNOS7420_MUX_SEL_TOPC3, 0, 2, \
			EXYNOS7420_MUX_STAT_TOPC3, 0, 4, 0, "mout_aclk_g2d_400"),
	MUX(none, "mout_aclk_hevc_532", topc_group1, \
			EXYNOS7420_MUX_SEL_TOPC3, 12, 2, \
			EXYNOS7420_MUX_STAT_TOPC3, 12, 4, 0, "mout_aclk_hevc_532"),
	/* top0 block */
	MUX(mout_aud_pll_user_top, "mout_aud_pll_user_top", mout_top0_aud_pll_p, \
			EXYNOS7420_MUX_SEL_TOP00, 0, 1, \
			EXYNOS7420_MUX_STAT_TOP00, 0, 3, 0, "mout_aud_pll_user_top"),
	...
	MUX(none, "mout_aclk_disp_400", top0_group1, \
			EXYNOS7420_MUX_SEL_TOP03, 28, 2, \
	...
	MUX(none, "mout_sclk_decon_int_eclk", top0_group1, \
			...
			EXYNOS7420_MUX_STAT_TOP0_DISP, 28, 4, 0, NULL),
	...
	MUX(mout_sclk_isp_sensor2, "mout_sclk_isp_sensor2", top0_group1, \
			EXYNOS7420_MUX_SEL_TOP0_CAM11, 0, 2, \
			EXYNOS7420_MUX_STAT_TOP0_CAM11, 0, 4, 0, NULL),
	MUX(mout_sclk_isp_sensor1, "mout_sclk_isp_sensor1", top0_group1, \
			EXYNOS7420_MUX_SEL_TOP0_CAM11, 8, 2, \
			EXYNOS7420_MUX_STAT_TOP0_CAM11, 8, 4, 0, NULL),
	MUX(mout_sclk_isp_sensor0, "mout_sclk_isp_sensor0", top0_group1, \
	...
	MUX(none, "mout_sclk_mmc2", top1_group1, \
			EXYNOS7420_MUX_SEL_TOP1_FSYS0, 24, 2, \
			EXYNOS7420_MUX_STAT_TOP1_FSYS0, 24, 4, 0, NULL),
	MUX(none, "mout_sclk_mmc1", top1_group1, \
			EXYNOS7420_MUX_SEL_TOP1_FSYS1, 24, 2, \
			EXYNOS7420_MUX_STAT_TOP1_FSYS1, 24, 4, 0, NULL),
	MUX(none, "mout_sclk_mmc0", top1_group1, \
			EXYNOS7420_MUX_SEL_TOP1_FSYS1, 28, 2, \
			EXYNOS7420_MUX_STAT_TOP1_FSYS1, 28, 4, 0, NULL),
	...
	MUX(none, "mout_sclk_ufsunipro11", top1_group1, \
	...
	MUX(m_decon0_vclk, "mout_sub_sclk_decon_int_vclk", mout_sub_sclk_decon_int_vclk_p, \
	...
	MUX(none, "mout_cam0_trex_532", top0_group2, \
			EXYNOS7420_MUX_SEL_TOP06, 20, 3,
			EXYNOS7420_MUX_STAT_TOP06, 20, 4, 0, "mout_cam0_trex_532"),
...
static struct samsung_composite_divider exynos7420_div_clks[] __refdata = {
	...
	DIV(none, "dout_aclk_ccore_532", "mout_aclk_ccore_532", \
			EXYNOS7420_DIV_TOPC0, 0, 3, \
			EXYNOS7420_DIV_STAT_TOPC0, 0, 1, 0, "dout_aclk_ccore_532"),
	DIV(none, "dout_aclk_peris_66", "mout_aclk_peris_66", \
			EXYNOS7420_DIV_TOPC1, 24, 3, \
			EXYNOS7420_DIV_STAT_TOPC1, 24, 1, 0, "dout_aclk_peris_66"),
	DIV(none, "dout_aclk_mscl_532", "mout_aclk_mscl_532", \
			EXYNOS7420_DIV_TOPC1, 20, 3, \
			EXYNOS7420_DIV_STAT_TOPC1, 20, 1, 0, "dout_aclk_mscl_532"),
	DIV(none, "dout_aclk_mfc_bus_532", "mout_aclk_mfc_bus_532", \
			EXYNOS7420_DIV_TOPC1, 16, 3, \
			EXYNOS7420_DIV_STAT_TOPC1, 16, 1, 0, "dout_aclk_mfc_bus_532"),
	DIV(none, "dout_aclk_mfc_532", "mout_aclk_mfc_532", \
			EXYNOS7420_DIV_TOPC1, 8, 3, \
			EXYNOS7420_DIV_STAT_TOPC1, 8, 1, 0, "dout_aclk_mfc_532"),
	DIV(none, "dout_aclk_g2d_266", "mout_aclk_g2d_266", \
			EXYNOS7420_DIV_TOPC1, 4, 3, \
			EXYNOS7420_DIV_STAT_TOPC1, 4, 1, 0, "dout_aclk_g2d_266"),
	DIV(none, "dout_aclk_g2d_400", "mout_aclk_g2d_400", \
			EXYNOS7420_DIV_TOPC1, 0, 3, \
			EXYNOS7420_DIV_STAT_TOPC1, 0, 1, 0, "dout_aclk_g2d_400"),
	DIV(none, "dout_aclk_hevc_532", "mout_aclk_hevc_532", \
			EXYNOS7420_DIV_TOPC1, 12, 3, \
			EXYNOS7420_DIV_STAT_TOPC1, 12, 1, 0, "dout_aclk_hevc_532"),
	/* top0 block */
	...
	DIV(dout_mmc2, "dout_sclk_mmc2", "mout_sclk_mmc2", \
			EXYNOS7420_DIV_TOP1_FSYS0, 24, 4, \
			EXYNOS7420_DIV_STAT_TOP1_FSYS0, 24, 1, 0, NULL),
	DIV(dout_mmc0, "dout_sclk_mmc0", "mout_sclk_mmc0", \
			EXYNOS7420_DIV_TOP1_FSYS1, 28, 4, \
			EXYNOS7420_DIV_STAT_TOP1_FSYS1, 28, 1, 0, NULL),
	...
	DIV(none, "dout_sclk_ufsunipro11", "mout_sclk_ufsunipro11", \
			EXYNOS7420_DIV_TOP1_FSYS0, 16, 6, \
	...
	/* bus block */
	DIV(none, "dout_pclk_bus0_133", "usermux_aclk_bus0_532", \
			EXYNOS7420_DIV_BUS0, 0, 3, \
			EXYNOS7420_DIV_STAT_BUS0, 0, 1, 0, NULL),
	DIV(none, "dout_pclk_bus1_133", "usermux_aclk_bus1_532", \
			EXYNOS7420_DIV_BUS1, 0, 3, \
			EXYNOS7420_DIV_STAT_BUS1, 0, 1, 0, NULL),
	/* aud block */
	...
	/* g3d block */
	DIV(dout_g3d, "dout_aclk_g3d", "mout_g3d", \
			EXYNOS7420_DIV_G3D, 0, 3, \
			EXYNOS7420_DIV_STAT_G3D, 0, 1, 0, NULL),
	/* disp block */
	...
	/* hevc block */
	DIV(dout_pclk_hevc, "dout_pclk_hevc", "usermux_aclk_hevc_532", \
			EXYNOS7420_DIV_HEVC, 0, 2, \
			EXYNOS7420_DIV_STAT_HEVC, 0, 1, 0, NULL),
	/* mif block */
	...
	/* g2d block */
	DIV(none, "dout_pclk_g2d", "usermux_aclk_g2d_266", \
			EXYNOS7420_DIV_G2D, 0, 2, \
			EXYNOS7420_DIV_STAT_G2D, 0, 1, 0, NULL),
	...
	DIV(dout_clkdiv_pclk_cam1_busperi_84, "dout_clkdiv_pclk_cam1_busperi_84", "mout_user_mux_aclk_cam1_busperi_334", \
...
static struct samsung_usermux exynos7420_usermux_clks[] __initdata = {
	...
	/* aud */
	USERMUX(none, "usermux_aud_pll_cmu", "aud_pll", \
			EXYNOS7420_MUX_SEL_AUD, 20, \
			EXYNOS7420_MUX_STAT_AUD, 20, 0, NULL),
	/* g3d */
	USERMUX(bus_pll_g3d, "usermux_bus_pll_g3d", "top_sclk_bus_pll_g3d", \
			EXYNOS7420_MUX_SEL_G3D, 4, \
			EXYNOS7420_MUX_STAT_G3D, 4, CLK_IGNORE_UNUSED, NULL),
	/* peris */
	...
	USERMUX(none, "usermux_sclk_decon_int_eclk", "top_sclk_decon_int_eclk", \
			...
			EXYNOS7420_MUX_STAT_DISP1, 28, 0, NULL),
	...
	/* fsys0 */
	USERMUX(none, "usermux_aclk_fsys0_200", "top_aclk_fsys0_200", \
	...
	USERMUX(none, "usermux_phyclk_usbdrd300_udrd30_pipe_pclk", \
			...
			0, 0, 0, NULL),
	USERMUX(none, "usermux_phyclk_usbhost20_phy_freeclk__hsic1", \
			"phyclk_usbhost20_phy_freeclk__hsic1", \
			EXYNOS7420_MUX_SEL_FSYS02, 20, \
			0, 0, 0, NULL),
	USERMUX(none, "usermux_phyclk_usbhost20_phy_phyclk__hsic1", \
			"phyclk_usbhost20_phy_phyclk__hsic1", \
			EXYNOS7420_MUX_SEL_FSYS02, 16, \
			0, 0, 0, NULL),
	USERMUX(none, "usermux_phyclk_lli_tx0_symbol", \
			"phyclk_lli_tx0_symbol", \
			EXYNOS7420_MUX_SEL_FSYS03, 20, \
			EXYNOS7420_MUX_STAT_FSYS03, 20, 0, NULL),
	USERMUX(none, "usermux_phyclk_lli_rx0_symbol", \
			"phyclk_lli_rx0_symbol", \
			EXYNOS7420_MUX_SEL_FSYS03, 16, \
			EXYNOS7420_MUX_STAT_FSYS03, 16, 0, NULL),
	USERMUX(none, "usermux_sclk_phy_fsys0", \
			"dout_sclk_phy_fsys0", \
			EXYNOS7420_MUX_SEL_FSYS01, 16, \
			EXYNOS7420_MUX_STAT_FSYS01, 16, 0, NULL),
	/* fsys1 */
	USERMUX(none, "usermux_aclk_fsys1_200", "top_aclk_fsys1_200", \
	...
	/* mfc */
	USERMUX(none, "usermux_aclk_mfc_bus_532", "top_aclk_mfc_bus_532", \
			EXYNOS7420_MUX_SEL_MFC, 4, \
			EXYNOS7420_MUX_STAT_MFC, 4, 0, NULL),
	USERMUX(none, "usermux_aclk_mfc_532", "top_aclk_mfc_532", \
			EXYNOS7420_MUX_SEL_MFC, 0, \
			EXYNOS7420_MUX_STAT_MFC, 0, 0, NULL),
	/* hevc */
	USERMUX(none, "usermux_aclk_hevc_532", "top_aclk_hevc_532", \
			EXYNOS7420_MUX_SEL_HEVC, 0, \
			EXYNOS7420_MUX_STAT_HEVC, 0, 0, NULL),
	/* atlas */
	...
	/* g2d */
	USERMUX(none, "usermux_aclk_g2d_266", "top_aclk_g2d_266", \
			EXYNOS7420_MUX_SEL_G2D, 4, \
			EXYNOS7420_MUX_STAT_G2D, 4, 0, NULL),
	USERMUX(none, "usermux_aclk_g2d_400", "top_aclk_g2d_400", \
			EXYNOS7420_MUX_SEL_G2D, 0, \
			EXYNOS7420_MUX_STAT_G2D, 0, 0, NULL),
...
static struct samsung_gate exynos7420_gate_clks[] __initdata = {
	...
	GATE(none, "sclk_bus1_pll_a", "dout_sclk_bus1_pll", \
			EXYNOS7420_ENABLE_SCLK_TOPC1, 12, CLK_GATE_ENABLE, NULL),
	...
	GATE(none, "sclk_cci_pll_a", "dout_sclk_cci_pll", \
			EXYNOS7420_ENABLE_SCLK_TOPC1, 0, CLK_IGNORE_UNUSED, NULL),
	GATE(none, "sclk_cci_pll_b", "dout_sclk_cci_pll", \
			EXYNOS7420_ENABLE_SCLK_TOPC1, 1, CLK_IGNORE_UNUSED, NULL),
	...
	GATE(none, "top_aclk_bus1_532", "dout_aclk_bus1_532", \
			EXYNOS7420_ENABLE_ACLK_TOPC0, 12, CLK_IGNORE_UNUSED, NULL),
	GATE(none, "top_aclk_bus1_200", "dout_aclk_bus1_200", \
			EXYNOS7420_ENABLE_ACLK_TOPC0, 16, CLK_IGNORE_UNUSED, NULL),
	GATE(none, "top_aclk_mfc_bus_532", "dout_aclk_mfc_bus_532", \
			EXYNOS7420_ENABLE_ACLK_TOPC1, 16, CLK_IGNORE_UNUSED, NULL),
	GATE(none, "top_aclk_mfc_532", "dout_aclk_mfc_532", \
			EXYNOS7420_ENABLE_ACLK_TOPC1, 8, 0, NULL),
	GATE(none, "top_aclk_hevc_532", "dout_aclk_hevc_532", \
			EXYNOS7420_ENABLE_ACLK_TOPC1, 12, 0, NULL),
	GATE(none, "top_aclk_g2d_266", "dout_aclk_g2d_266", \
			EXYNOS7420_ENABLE_ACLK_TOPC1, 4, 0, NULL),
	GATE(none, "top_aclk_g2d_400", "dout_aclk_g2d_400", \
			EXYNOS7420_ENABLE_ACLK_TOPC1, 0, 0, NULL),
	...
	GATE(baud0, "top_sclk_uart0", "dout_sclk_uart0", \
			EXYNOS7420_ENABLE_SCLK_TOP0_PERIC3, 16, 0, NULL),
	GATE(baud1, "top_sclk_uart1", "dout_sclk_uart1", \
			EXYNOS7420_ENABLE_SCLK_TOP0_PERIC3, 12, 0, NULL),
	GATE(baud2, "top_sclk_uart2", "dout_sclk_uart2", \
			EXYNOS7420_ENABLE_SCLK_TOP0_PERIC3, 8, 0, NULL),
	GATE(baud3, "top_sclk_uart3", "dout_sclk_uart3", \
			EXYNOS7420_ENABLE_SCLK_TOP0_PERIC3, 4, 0, NULL),
	GATE(none, "top_sclk_spi0", "dout_sclk_spi0", \
			EXYNOS7420_ENABLE_SCLK_TOP0_PERIC1, 20, 0, NULL),
	GATE(none, "top_sclk_spi1", "dout_sclk_spi1", \
			EXYNOS7420_ENABLE_SCLK_TOP0_PERIC1, 8, 0, NULL),
	GATE(none, "top_sclk_spi2", "dout_sclk_spi2", \
			EXYNOS7420_ENABLE_SCLK_TOP0_PERIC2, 20, 0, NULL),
	GATE(none, "top_sclk_spi3", "dout_sclk_spi3", \
			EXYNOS7420_ENABLE_SCLK_TOP0_PERIC2, 8, 0, NULL),
	GATE(none, "top_sclk_spi4", "dout_sclk_spi4", \
			EXYNOS7420_ENABLE_SCLK_TOP0_PERIC3, 20, 0, NULL),
	...
	GATE(none, "top_sclk_mmc2", "dout_sclk_mmc2", \
			EXYNOS7420_ENABLE_SCLK_TOP1_FSYS0, 24, 0, NULL),
	GATE(none, "top_sclk_mmc0", "dout_sclk_mmc0", \
			EXYNOS7420_ENABLE_SCLK_TOP1_FSYS1, 28, 0, NULL),
	/* vpp */
	...
	GATE(aclk_vg1, "aclk_vpp_idma_vg1", "usermux_aclk_vpp1_400", \
			EXYNOS7420_ENABLE_ACLK_VPP, 1, 0, NULL),
	GATE(aclk_vgr1, "aclk_vpp_idma_vgr1", "usermux_aclk_vpp1_400", \
			EXYNOS7420_ENABLE_ACLK_VPP, 3, 0, NULL),
	GATE(none, "aclk_axi_lh_async_si_vpp1", "usermux_aclk_vpp1_400", \
			EXYNOS7420_ENABLE_ACLK_VPP, 15, 0, NULL),
	GATE(none, "aclk_xiu_vppx1", "aclk_axi_lh_async_si_vpp1", \
			EXYNOS7420_ENABLE_ACLK_VPP, 17, 0, NULL),
	GATE(aclk_vpp1, "aclk_cp_vpp1", "aclk_xiu_vppx1", \
			EXYNOS7420_ENABLE_ACLK_VPP, 25, 0, NULL),

	GATE(aclk_vg0, "aclk_vpp_idma_vg0", "usermux_aclk_vpp0_400", \
			EXYNOS7420_ENABLE_ACLK_VPP, 0, 0, NULL),
	GATE(aclk_vgr0, "aclk_vpp_idma_vgr0", "usermux_aclk_vpp0_400", \
			EXYNOS7420_ENABLE_ACLK_VPP, 2, 0, NULL),
	GATE(none, "aclk_axi_lh_async_si_vpp0", "usermux_aclk_vpp0_400", \
			EXYNOS7420_ENABLE_ACLK_VPP, 14, 0, NULL),
	GATE(none, "aclk_xiu_vppx0", "aclk_axi_lh_async_si_vpp0", \
			EXYNOS7420_ENABLE_ACLK_VPP, 16, 0, NULL),
	GATE(aclk_vpp0, "aclk_cp_vpp0", "aclk_xiu_vppx0", \
			EXYNOS7420_ENABLE_ACLK_VPP, 24, 0, NULL),

	GATE(pclk_vpp, "pclk_vpp", "dout_pclk_vpp_133", \
			EXYNOS7420_ENABLE_PCLK_VPP, 20, 0, NULL),
	GATE(pclk_cp_vpp0, "pclk_cp_vpp0", "dout_pclk_vpp_133", \
			EXYNOS7420_ENABLE_PCLK_VPP, 24, 0, NULL),
	GATE(pclk_cp_vpp1, "pclk_cp_vpp1", "dout_pclk_vpp_133", \
			EXYNOS7420_ENABLE_PCLK_VPP, 25, 0, NULL),
	...
	/* g3d */
	GATE(g3d, "aclk_g3d", "dout_aclk_g3d", \
			EXYNOS7420_ENABLE_ACLK_G3D, 0, CLK_IGNORE_UNUSED, NULL),
	/* peris */
	GATE(mct, "pclk_mct", "usermux_aclk_peris_66", \
			EXYNOS7420_ENABLE_PCLK_PERIS, 5, CLK_IGNORE_UNUSED, NULL),
	GATE(wdt_apl, "pclk_wdt_apl", "usermux_aclk_peris_66",\
			EXYNOS7420_ENABLE_PCLK_PERIS, 7, CLK_IGNORE_UNUSED, NULL),
	/* peric0 */
	GATE(puart0, "pclk_uart0", "usermux_aclk_peric0_66", \
			EXYNOS7420_ENABLE_PCLK_PERIC0, 16, \
			CLK_IGNORE_UNUSED, "console-pclk0"),
	GATE(suart0, "sclk_uart0", "usermux_sclk_uart0", \
			EXYNOS7420_ENABLE_SCLK_PERIC0, 16, \
			CLK_IGNORE_UNUSED, "console-sclk0"),
	...
	GATE(puart1, "pclk_uart1", "usermux_aclk_peric1_66", \
			EXYNOS7420_ENABLE_PCLK_PERIC1, 9, \
			CLK_IGNORE_UNUSED, "console-pclk1"),
	GATE(puart2, "pclk_uart2", "usermux_aclk_peric1_66", \
			EXYNOS7420_ENABLE_PCLK_PERIC1, 10, \
			CLK_IGNORE_UNUSED, "console-pclk2"),
	GATE(puart3, "pclk_uart3", "usermux_aclk_peric1_66", \
			EXYNOS7420_ENABLE_PCLK_PERIC1, 11, \
			0, "console-pclk3"),
	GATE(suart1, "sclk_uart1", "usermux_sclk_uart1", \
			EXYNOS7420_ENABLE_SCLK_PERIC10, 9, \
			CLK_IGNORE_UNUSED, "console-sclk1"),
	GATE(suart2, "sclk_uart2", "usermux_sclk_uart2", \
			EXYNOS7420_ENABLE_SCLK_PERIC10, 10, \
			CLK_IGNORE_UNUSED, "console-sclk2"),
	GATE(suart3, "sclk_uart3", "usermux_sclk_uart3", \
			EXYNOS7420_ENABLE_SCLK_PERIC10, 11, \
			0, "console-sclk3"),
	...
	/* mfc */
	GATE(aclk_lh_s_mfc_0, "aclk_lh_s_mfc_0", "usermux_aclk_mfc_bus_532", \
			EXYNOS7420_ENABLE_ACLK_MFC, 31, 0, NULL),
	GATE(aclk_lh_s_mfc_1, "aclk_lh_s_mfc_1", "usermux_aclk_mfc_bus_532", \
			EXYNOS7420_ENABLE_ACLK_MFC, 30, 0, NULL),
	GATE(aclk_xiu_mfc_0, "aclk_xiu_mfc_0", "usermux_aclk_mfc_bus_532", \
			EXYNOS7420_ENABLE_ACLK_MFC, 27, 0, NULL),
	GATE(aclk_xiu_mfc_1, "aclk_xiu_mfc_1", "usermux_aclk_mfc_bus_532", \
			EXYNOS7420_ENABLE_ACLK_MFC, 26, 0, NULL),
	GATE(aclk_xiu_n_async_m_mfc_0, "aclk_xiu_n_async_m_mfc_0", "usermux_aclk_mfc_bus_532", \
			EXYNOS7420_ENABLE_ACLK_MFC, 23, 0, NULL),
	GATE(aclk_xiu_n_async_m_mfc_1, "aclk_xiu_n_async_m_mfc_1", "usermux_aclk_mfc_bus_532", \
			EXYNOS7420_ENABLE_ACLK_MFC, 22, 0, NULL),
	GATE(aclk_cp_mfc_0, "aclk_cp_mfc_0", "usermux_aclk_mfc_bus_532", \
			EXYNOS7420_ENABLE_ACLK_MFC, 21, 0, NULL),
	GATE(aclk_cp_mfc_1, "aclk_cp_mfc_1", "usermux_aclk_mfc_bus_532", \
			EXYNOS7420_ENABLE_ACLK_MFC, 20, 0, NULL),
	GATE(aclk_mfc, "aclk_mfc", "usermux_aclk_mfc_532", \
			EXYNOS7420_ENABLE_ACLK_MFC, 19, 0, NULL),
	GATE(aclk_xiu_n_async_s_mfc_0, "aclk_xiu_n_async_s_mfc_0", "usermux_aclk_mfc_532", \
			EXYNOS7420_ENABLE_ACLK_MFC, 18, 0, NULL),
	GATE(aclk_xiu_n_async_s_mfc_1, "aclk_xiu_n_async_s_mfc_1", "usermux_aclk_mfc_532", \
			EXYNOS7420_ENABLE_ACLK_MFC, 17, 0, NULL),
	GATE(pclk_mfc, "pclk_mfc", "dout_pclk_mfc", \
			EXYNOS7420_ENABLE_PCLK_MFC, 31, 0, NULL),
	GATE(pclk_xiu_n_async_mfc_0, "pclk_xiu_n_async_mfc_0", "dout_pclk_mfc", \
			EXYNOS7420_ENABLE_PCLK_MFC, 24, 0, NULL),
	GATE(pclk_xiu_n_async_mfc_1, "pclk_xiu_n_async_mfc_1", "dout_pclk_mfc", \
			EXYNOS7420_ENABLE_PCLK_MFC, 23, 0, NULL),
	GATE(pclk_cp_mfc_0, "pclk_cp_mfc_0", "dout_pclk_mfc", \
			EXYNOS7420_ENABLE_PCLK_MFC, 22, 0, NULL),
	GATE(pclk_cp_mfc_1, "pclk_cp_mfc_1", "dout_pclk_mfc", \
			EXYNOS7420_ENABLE_PCLK_MFC, 21, 0, NULL),
	/* hevc */
	GATE(aclk_hevc, "aclk_hevc", "usermux_aclk_hevc_532", \
			EXYNOS7420_ENABLE_ACLK_HEVC, 31, 0, NULL),
	GATE(aclk_lh_async_s_hevc_0, "aclk_lh_async_s_hevc_0", "usermux_aclk_hevc_532", \
			EXYNOS7420_ENABLE_ACLK_HEVC, 30, 0, NULL),
	GATE(aclk_lh_async_s_hevc_1, "aclk_lh_async_s_hevc_1", "usermux_aclk_hevc_532", \
			EXYNOS7420_ENABLE_ACLK_HEVC, 29, 0, NULL),
	GATE(pclk_hevc, "pclk_hevc", "dout_pclk_hevc", \
			EXYNOS7420_ENABLE_PCLK_HEVC, 31, 0, NULL),
	...
	GATE(none, "aclk_xiu_disp_rw", "aclk_lh_async_si_top_disp", \
			EXYNOS7420_ENABLE_ACLK_DISP, 26, 0, NULL),
	GATE(aclk_disp, "aclk_cp_disp", "aclk_xiu_disp_rw", \
			EXYNOS7420_ENABLE_ACLK_DISP, 21, 0, NULL),
	...
	GATE(none, "pclk_ahb2apb_disp0p", "dout_pclk_disp", \
			EXYNOS7420_ENABLE_PCLK_DISP, 25, 0, NULL),
	GATE(pclk_disp, "pclk_cp_disp", "pclk_ahb2apb_disp0p", \
			EXYNOS7420_ENABLE_PCLK_DISP, 18, 0, NULL),
	...
	GATE(mipi0_rx, "mipidphy0_rx", "usermux_mipidphy0_rx", \
			EXYNOS7420_ENABLE_SCLK_DISP2, 12, CLK_IGNORE_UNUSED, NULL),
	GATE(mipi0_bit, "mipidphy0_bit", "usermux_mipidphy0_bit", \
			EXYNOS7420_ENABLE_SCLK_DISP2, 8, CLK_IGNORE_UNUSED, NULL),
	GATE(mipi1_rx, "mipidphy1_rx", "usermux_mipidphy1_rx", \
			EXYNOS7420_ENABLE_SCLK_DISP2, 4, CLK_IGNORE_UNUSED, NULL),
	GATE(mipi1_bit, "mipidphy1_bit", "usermux_mipidphy1_bit", \
			EXYNOS7420_ENABLE_SCLK_DISP2, 0, CLK_IGNORE_UNUSED, NULL),
	GATE(decon1_eclk, "decon1_eclk", "dout_sub_sclk_decon_ext_eclk", \
			EXYNOS7420_ENABLE_SCLK_DISP1, 24, 0, NULL),
	GATE(decon1_vclk, "decon1_vclk", "usermux_hdmiphy_pixel", \
	...
	/* fsys0 */
	GATE(pdma0, "aclk_pdma0", "usermux_aclk_fsys0_200", \
			EXYNOS7420_ENABLE_ACLK_FSYS00, 4, 0, NULL),
	GATE(pdma1, "aclk_pdma1", "usermux_aclk_fsys0_200", \
	...
	GATE(user_phyclk_usbhost20_phy_freeclk__hsic1, \
			"user_phyclk_usbhost20_phy_freeclk__hsic1", \
			"usermux_phyclk_usbhost20_phy_freeclk__hsic1", \
			EXYNOS7420_ENABLE_SCLK_FSYS02, 20, 0, NULL),
	GATE(user_phyclk_usbhost20_phy_phyclk__hsic1, \
			"user_phyclk_usbhost20_phy_phyclk__hsic1", \
			"usermux_phyclk_usbhost20_phy_phyclk__hsic1", \
			EXYNOS7420_ENABLE_SCLK_FSYS02, 16, 0, NULL),
	GATE(aclk_mmc2, "aclk_mmc2", "usermux_aclk_fsys0_200", \
	...
	GATE(aclk_combo_phy_modem_pclk, "aclk_combo_phy_modem_pclk", \
			"usermux_aclk_fsys0_200", \
			EXYNOS7420_ENABLE_ACLK_FSYS01, 17, 0, NULL),
	GATE(sclk_phy_fsys0, "sclk_phy_fsys0", "usermux_sclk_phy_fsys0", \
			EXYNOS7420_ENABLE_ACLK_FSYS01, 16, 0, NULL),
	GATE(sclk_combo_phy_modem_26m, "sclk_combo_phy_modem_26m", \
			"sclk_combo_phy_modem", \
	...
	GATE(aclk_axius_lli_be, "aclk_axius_lli_be", \
			"usermux_aclk_fsys0_200", \
			EXYNOS7420_ENABLE_ACLK_FSYS00, 17, 0, NULL),
	GATE(aclk_axius_lli_ll, "aclk_axius_lli_ll", \
			"usermux_aclk_fsys0_200", \
			EXYNOS7420_ENABLE_ACLK_FSYS00, 16, 0, NULL),
	GATE(axius_llisfrx_llill, "axius_llisfrx_llill", \
			"usermux_aclk_fsys0_200", \
			EXYNOS7420_ENABLE_ACLK_FSYS00, 14, 0, NULL),
	GATE(axius_llisfrx_llibe, "axius_llisfrx_llibe", \
			"usermux_aclk_fsys0_200", \
			EXYNOS7420_ENABLE_ACLK_FSYS00, 13, 0, NULL),
	GATE(aclk_lli_ll_init , "aclk_lli_ll_init ", \
			"usermux_aclk_fsys0_200", \
			EXYNOS7420_ENABLE_ACLK_FSYS01, 24, 0, NULL),
	GATE(aclk_lli_ll_target, "aclk_lli_ll_target", \
			"usermux_aclk_fsys0_200", \
	...
	GATE(aclk_lli_be_target, "aclk_lli_be_target", \
			"usermux_aclk_fsys0_200", \
	...
	/* mscl */
	/*
	 * NOTE: This clock hierarch is not available if USER_ACLK_MSCL_532
	 *       gate clock is defined!!!
	 * usermux_aclk_mscl_532 <- dout_pclk_mscl
	 *       <- pclk_cp_mscl0, pclk_cp_mscl1
	 *
	 * pclk_cp_mscl0 <- aclk_xiu_mscl <- aclk_lhasync_mscl0
	 *       <- aclk_cp_mscl0 <- pclk_jpeg(<-sclk_jpeg<-aclk_jpeg)
	 *         , pclk_m2mscaler0(<-aclk_m2mscaler0)
	 *         , pclk_smmu_mscl0(<-aclk_smmu_mscl0).
	 * pclk_cp_mscl1 <- aclk_lhasync_mscl1 <- aclk_cp_mscl1
	 *       <-  pclk_m2mscaler1(<-aclk_m2mscaler1)
	 *         , pclk_smmu_mscl1(<-aclk_smmu_mscl1).
	 */
	GATE(CLK_ACLK_M2MSCALER0, "aclk_m2mscaler0", "pclk_m2mscaler0",
			EXYNOS7420_ENABLE_ACLK_MSCL, 31, 0, NULL),
	GATE(CLK_ACLK_M2MSCALER1, "aclk_m2mscaler1", "pclk_m2mscaler1",
			EXYNOS7420_ENABLE_ACLK_MSCL, 30, 0, NULL),
	GATE(CLK_ACLK_JPEG, "aclk_jpeg", "sclk_jpeg",
			EXYNOS7420_ENABLE_ACLK_MSCL, 29, 0, NULL),
	GATE(CLK_ACLK_LH_ASYNC_SI_MSCL0,
			"aclk_lhasync_mscl0", "aclk_xiu_mscl",
			EXYNOS7420_ENABLE_ACLK_MSCL, 28, 0, NULL),
	GATE(CLK_ACLK_LH_ASYNC_SI_MSCL1,
			"aclk_lhasync_mscl1", "pclk_cp_mscl1",
			EXYNOS7420_ENABLE_ACLK_MSCL, 27, 0, NULL),
	GATE(CLK_ACLK_XIU_MSCLX, "aclk_xiu_mscl", "pclk_cp_mscl0",
			EXYNOS7420_ENABLE_ACLK_MSCL, 26, 0, NULL),
	GATE(CLK_ACLK_CP_MSCL0, "aclk_cp_mscl0", "aclk_lhasync_mscl0",
			EXYNOS7420_ENABLE_ACLK_MSCL, 20, 0, NULL),
	GATE(CLK_ACLK_CP_MSCL1, "aclk_cp_mscl1", "aclk_lhasync_mscl1",
			EXYNOS7420_ENABLE_ACLK_MSCL, 19, 0, NULL),

	GATE(CLK_PCLK_M2MSCALER0, "pclk_m2mscaler0", "aclk_cp_mscl0",
			EXYNOS7420_ENABLE_PCLK_MSCL, 31, 0, NULL),
	GATE(CLK_PCLK_M2MSCALER1, "pclk_m2mscaler1", "aclk_cp_mscl1",
			EXYNOS7420_ENABLE_PCLK_MSCL, 30, 0, NULL),
	GATE(CLK_PCLK_JPEG, "pclk_jpeg", "aclk_cp_mscl0",
			EXYNOS7420_ENABLE_PCLK_MSCL, 29, 0, NULL),
	GATE(CLK_PCLK_CP_MSCL0, "pclk_cp_mscl0", "dout_pclk_mscl",
			EXYNOS7420_ENABLE_PCLK_MSCL, 23, 0, NULL),
	GATE(CLK_PCLK_CP_MSCL1, "pclk_cp_mscl1", "dout_pclk_mscl",
			EXYNOS7420_ENABLE_PCLK_MSCL, 22, 0, NULL),

	GATE(CLK_PCLK_JPEG, "sclk_jpeg", "pclk_jpeg",
			EXYNOS7420_ENABLE_SCLK_MSCL, 28, 0, NULL),

	GATE(CLK_ACLK_SYSMMU_MSCL0, "aclk_smmu_mscl0", "pclk_smmu_mscl0",
			EXYNOS7420_ENABLE_ACLK_MSCL_SMMU0, 0, 0, NULL),
	GATE(CLK_ACLK_SYSMMU_MSCL1, "aclk_smmu_mscl1", "pclk_smmu_mscl1",
			EXYNOS7420_ENABLE_ACLK_MSCL_SMMU1, 0, 0, NULL),
	GATE(CLK_PCLK_SYSMMU_MSCL0, "pclk_smmu_mscl0", "aclk_cp_mscl0",
			EXYNOS7420_ENABLE_PCLK_MSCL_SMMU0, 0, 0, NULL),
	GATE(CLK_PCLK_SYSMMU_MSCL1, "pclk_smmu_mscl1", "aclk_cp_mscl1",
			EXYNOS7420_ENABLE_PCLK_MSCL_SMMU1, 0, 0, NULL),
	/**
	 * G2D ACLK Clocks
	 */
	GATE(CLK_ACLK_G2D, "aclk_g2d", "aclk_g2dnd_400", \
			EXYNOS7420_ENABLE_ACLK_G2D, 31, 0, NULL),
	GATE(CLK_ACLK_G2D_ND_400, "aclk_g2dnd_400", "aclk_xiu_g2dx", \
			EXYNOS7420_ENABLE_ACLK_G2D, 30, 0, NULL),
	GATE(CLK_ACLK_G2D_XIU, "aclk_xiu_g2dx", "aclk_alb_g2d", \
			EXYNOS7420_ENABLE_ACLK_G2D, 29, 0, NULL),
	GATE(CLK_ACLK_G2D_ALB, "aclk_alb_g2d", "aclk_lh_g2d", \
			EXYNOS7420_ENABLE_ACLK_G2D, 26, 0, NULL),
	GATE(CLK_ACLK_G2D_LH, "aclk_lh_g2d", "usermux_aclk_g2d_400", \
			EXYNOS7420_ENABLE_ACLK_BUS1, 26, 0, NULL),
	GATE(CLK_PCLK_G2D, "pclk_g2d", "pclk_alb_g2d", \
			EXYNOS7420_ENABLE_PCLK_G2D, 31, 0, NULL),
	GATE(CLK_PCLK_G2D_ALB, "pclk_alb_g2d", "dout_pclk_g2d", \
			EXYNOS7420_ENABLE_PCLK_G2D, 28, 0, NULL),

	GATE(CLK_ACLK_G2D_SYSMMU, "aclk_smmu_g2d", "usermux_aclk_g2d_400", \
			EXYNOS7420_ENABLE_ACLK_G2D_SMMU, 0, 0, NULL),
	GATE(CLK_PCLK_G2D_SYSMMU, "pclk_smmu_g2d", "dout_pclk_g2d", \
			EXYNOS7420_ENABLE_PCLK_G2D_SMMU, 0, 0, NULL),

	/* G2D BTS & PPMU */
	GATE(CLK_ACLK_G2D_BTS, "aclk_bts_g2d", "usermux_aclk_g2d_400", \
			EXYNOS7420_ENABLE_ACLK_G2D, 25, 0, NULL),
	GATE(CLK_ACLK_G2D_PPMU, "aclk_ppmu_g2dx", "usermux_aclk_g2d_400", \
			EXYNOS7420_ENABLE_ACLK_G2D, 24, 0, NULL),
	GATE(CLK_PCLK_G2D_BTS, "pclk_bts_g2d", "dout_pclk_g2d", \
			EXYNOS7420_ENABLE_PCLK_G2D, 27, 0, NULL),
	GATE(CLK_PCLK_G2D_PPMU, "pclk_ppmu_g2dx", "dout_pclk_g2d", \
			EXYNOS7420_ENABLE_PCLK_G2D, 25, 0, NULL),

	/* top - isp0 */
	GATE(aclk_isp0_isp0_590, "aclk_isp0_isp0_590", "mout_aclk_isp0_isp0_590", \
			EXYNOS7420_ENABLE_ACLK_TOP04, 28, CLK_IGNORE_UNUSED, 0),
	GATE(aclk_isp0_tpu_590, "aclk_isp0_tpu_590", "mout_aclk_isp0_tpu_590", \
			EXYNOS7420_ENABLE_ACLK_TOP04, 24, CLK_IGNORE_UNUSED, 0),
	GATE(aclk_isp0_trex_532, "aclk_isp0_trex_532", "mout_aclk_isp0_trex_532", \
			EXYNOS7420_ENABLE_ACLK_TOP04, 20, CLK_IGNORE_UNUSED, 0),

	/* top - isp1 */
	GATE(aclk_isp1_isp1_468, "aclk_isp1_isp1_468", "mout_aclk_isp1_isp1_468", \
			EXYNOS7420_ENABLE_ACLK_TOP04, 16, CLK_IGNORE_UNUSED, 0),
	GATE(aclk_isp1_ahb_117, "aclk_isp1_ahb_117", "mout_aclk_isp1_ahb_117", \
			EXYNOS7420_ENABLE_ACLK_TOP04, 12, CLK_IGNORE_UNUSED, 0),

	/* top - cam0 */
	GATE(aclk_cam0_csis0_690, "aclk_cam0_csis0_690", "dout_aclk_cam0_csis0_690", \
			EXYNOS7420_ENABLE_ACLK_TOP05, 28, CLK_IGNORE_UNUSED, 0),
	GATE(aclk_cam0_bnsa_690, "aclk_cam0_bnsa_690", "dout_aclk_cam0_bnsa_690", \
			EXYNOS7420_ENABLE_ACLK_TOP05, 24, CLK_IGNORE_UNUSED, 0),
	GATE(aclk_cam0_bnsb_690, "aclk_cam0_bnsb_690", "dout_aclk_cam0_bnsb_690", \
			EXYNOS7420_ENABLE_ACLK_TOP05, 20, CLK_IGNORE_UNUSED, 0),
	GATE(aclk_cam0_bnsd_690, "aclk_cam0_bnsd_690", "dout_aclk_cam0_bnsd_690", \
			EXYNOS7420_ENABLE_ACLK_TOP05, 16, CLK_IGNORE_UNUSED, 0),
	GATE(aclk_cam0_csis1_174, "aclk_cam0_csis1_174", "dout_aclk_cam0_csis1_174", \
			EXYNOS7420_ENABLE_ACLK_TOP05, 12, CLK_IGNORE_UNUSED, 0),
	GATE(aclk_cam0_3aa0_690, "aclk_cam0_3aa0_690", "dout_aclk_cam0_3aa0_690", \
			EXYNOS7420_ENABLE_ACLK_TOP06, 28, CLK_IGNORE_UNUSED, 0),
	GATE(aclk_cam0_3aa1_468, "aclk_cam0_3aa1_468", "dout_aclk_cam0_3aa1_468", \
			EXYNOS7420_ENABLE_ACLK_TOP06, 24, CLK_IGNORE_UNUSED, 0),
	GATE(aclk_cam0_trex_532, "aclk_cam0_trex_532", "dout_aclk_cam0_trex_532", \
			EXYNOS7420_ENABLE_ACLK_TOP06, 20, CLK_IGNORE_UNUSED, 0),
	GATE(aclk_cam0_nocp_133, "aclk_cam0_nocp_133", "dout_aclk_cam0_nocp_133", \
			EXYNOS7420_ENABLE_ACLK_TOP06, 16, CLK_IGNORE_UNUSED, 0),

	/* top - cam1 */
	GATE(aclk_cam1_sclvra_491, "aclk_cam1_sclvra_491", "dout_aclk_cam1_sclvra_491", \
			EXYNOS7420_ENABLE_ACLK_TOP07, 28, CLK_IGNORE_UNUSED, 0),
	GATE(aclk_cam1_arm_668, "aclk_cam1_arm_668", "dout_aclk_cam1_arm_668", \
			EXYNOS7420_ENABLE_ACLK_TOP07, 24, CLK_IGNORE_UNUSED, 0),
	GATE(aclk_cam1_busperi_334, "aclk_cam1_busperi_334", "dout_aclk_cam1_busperi_334", \
			EXYNOS7420_ENABLE_ACLK_TOP07, 20, CLK_IGNORE_UNUSED, 0),
	GATE(aclk_cam1_bnscsis_133, "aclk_cam1_bnscsis_133", "dout_aclk_cam1_bnscsis_133", \
			EXYNOS7420_ENABLE_ACLK_TOP07, 16, CLK_IGNORE_UNUSED, 0),
	GATE(aclk_cam1_nocp_133, "aclk_cam1_nocp_133", "dout_aclk_cam1_nocp_133", \
			EXYNOS7420_ENABLE_ACLK_TOP07, 12, CLK_IGNORE_UNUSED, 0),
	GATE(aclk_cam1_trex_532, "aclk_cam1_trex_532", "dout_aclk_cam1_trex_532", \
			EXYNOS7420_ENABLE_ACLK_TOP07, 8, CLK_IGNORE_UNUSED, 0),
	GATE(sclk_isp_spi0, "sclk_isp_spi0", "dout_sclk_isp_spi0", \
			EXYNOS7420_ENABLE_SCLK_TOP0_CAM10, 20, CLK_IGNORE_UNUSED, 0),
	GATE(sclk_isp_spi1, "sclk_isp_spi1", "dout_sclk_isp_spi1", \
			EXYNOS7420_ENABLE_SCLK_TOP0_CAM10, 8, CLK_IGNORE_UNUSED, 0),
	GATE(sclk_isp_uart, "sclk_isp_uart", "dout_sclk_isp_uart", \
			EXYNOS7420_ENABLE_SCLK_TOP0_CAM10, 4, CLK_IGNORE_UNUSED, 0),
	...
	GATE(none, "gate_aclk_axi2apb_bridge_is0p", "dout_clkdiv_pclk_cam0_trex_266", \
	...
	GATE(none, "gate_aclk_xiu_is0x", "dout_clkdiv_pclk_cam0_trex_266", \
			EXYNOS7420_ENABLE_ACLK_CAM01, 19, CLK_IGNORE_UNUSED, 0),
	GATE(none, "gate_aclk_axi2ahb", "dout_clkdiv_pclk_cam0_trex_266", \
			EXYNOS7420_ENABLE_ACLK_CAM01, 8, CLK_IGNORE_UNUSED, 0),
	GATE(none, "gate_hclk_ahbsyncdn_cam0", "dout_clkdiv_pclk_cam0_trex_266", \
			EXYNOS7420_ENABLE_ACLK_CAM01, 12, CLK_IGNORE_UNUSED, 0),
	GATE(none, "gate_aclk_xiu_async_mi_cam0", "dout_clkdiv_pclk_cam0_trex_266", \
			EXYNOS7420_ENABLE_ACLK_CAM01, 16, CLK_IGNORE_UNUSED, 0),
	GATE(none, "gate_pclk_xiu_async_mi_cam0", "dout_clkdiv_pclk_cam0_trex_266", \
			EXYNOS7420_ENABLE_PCLK_CAM01, 16, CLK_IGNORE_UNUSED, 0),
	GATE(none, "gate_aclk_xiu_async_mi_is0x", "dout_clkdiv_pclk_cam0_trex_266", \
			EXYNOS7420_ENABLE_ACLK_CAM01, 17, CLK_IGNORE_UNUSED, 0),
	GATE(none, "gate_pclk_xiu_async_mi_is0x", "dout_clkdiv_pclk_cam0_trex_133", \
			EXYNOS7420_ENABLE_PCLK_CAM01, 17, CLK_IGNORE_UNUSED, 0),
	GATE(none, "gate_pclk_pmu_cam0", "dout_clkdiv_pclk_cam0_trex_133", \
			EXYNOS7420_ENABLE_PCLK_CAM00, 31, CLK_IGNORE_UNUSED, 0),
	GATE(none, "gate_hclk_ahb2apb_bridge_is0p", "dout_clkdiv_pclk_cam0_trex_133", \
			EXYNOS7420_ENABLE_ACLK_CAM01, 9, CLK_IGNORE_UNUSED, 0),
	...
	GATE(none, "gate_aclk_200_cam0_noc_p_cam0", "mout_user_mux_aclk_cam0_nocp_133", \
			EXYNOS7420_ENABLE_ACLK_CAM01, 28, CLK_IGNORE_UNUSED, 0),
	GATE(none, "gate_aclk_xiu_async_si_is0x", "mout_user_mux_aclk_cam0_nocp_133", \
	...
	GATE(none, "gate_aclk_xiu_n_async_si_cortex", "mout_user_mux_aclk_cam1_arm_668",     \
			EXYNOS7420_ENABLE_ACLK_CAM11, 24, CLK_IGNORE_UNUSED, 0),
	GATE(none, "gate_clk_mcu_isp_400_isp_arm_sys", "mout_user_mux_aclk_cam1_arm_668", \
	...
	GATE(none, "gate_aclk_axi2apb_bridge_is3p", "mout_user_mux_aclk_cam1_busperi_334",     \
			EXYNOS7420_ENABLE_ACLK_CAM11, 16, CLK_IGNORE_UNUSED, 0),
	GATE(none, "gate_aclk_axispcx", "mout_user_mux_aclk_cam1_busperi_334", \
			EXYNOS7420_ENABLE_ACLK_CAM11, 17, CLK_IGNORE_UNUSED, 0),
	GATE(none, "gate_aclk_axisphx", "mout_user_mux_aclk_cam1_busperi_334", \
			EXYNOS7420_ENABLE_ACLK_CAM11, 18, CLK_IGNORE_UNUSED, 0),
	GATE(none, "gate_aclk_gic_isp_arm_sys", "mout_user_mux_aclk_cam1_busperi_334", \
			EXYNOS7420_ENABLE_ACLK_CAM10, 16, CLK_IGNORE_UNUSED, 0),
	GATE(none, "gate_aclk_r_axispcx", "mout_user_mux_aclk_cam1_busperi_334", \
			EXYNOS7420_ENABLE_ACLK_CAM10, 20, CLK_IGNORE_UNUSED, 0),
	GATE(none, "gate_aclk_r_axisphx", "mout_user_mux_aclk_cam1_busperi_334", \
			EXYNOS7420_ENABLE_ACLK_CAM10, 21, CLK_IGNORE_UNUSED, 0),
	GATE(none, "gate_aclk_xiu_ispx_1x4", "mout_user_mux_aclk_cam1_busperi_334", \
			EXYNOS7420_ENABLE_ACLK_CAM10, 13, CLK_IGNORE_UNUSED, 0),
	GATE(none, "gate_aclk_xiu_n_async_mi_cortex", "mout_user_mux_aclk_cam1_busperi_334", \
	...
	GATE(none, "gate_aclk_xiu_n_async_si_to_blkc", "mout_user_mux_aclk_cam1_busperi_334", \
			EXYNOS7420_ENABLE_ACLK_CAM11, 25, CLK_IGNORE_UNUSED, 0),
	GATE(none, "gate_aclk_xiu_n_async_si_to_blkd", "mout_user_mux_aclk_cam1_busperi_334", \
	...
	GATE(none, "gate_hclk_ahbsyncdn_isp2h", "mout_user_mux_aclk_cam1_busperi_334", \
			EXYNOS7420_ENABLE_ACLK_CAM11, 4, CLK_IGNORE_UNUSED, 0),
	GATE(none, "gate_hclkm_asyncahb_cam1", "mout_user_mux_aclk_cam1_busperi_334", \
	...
	GATE(none,"gate_pclk_xiu_n_async_mi_cortex", "dout_clkdiv_pclk_cam1_busperi_167", \
			EXYNOS7420_ENABLE_PCLK_CAM11, 21, CLK_IGNORE_UNUSED, 0),

	GATE(none, "gate_hclk_ahb_sfrisp2h", "dout_clkdiv_pclk_cam1_busperi_84", \
			EXYNOS7420_ENABLE_ACLK_CAM11, 0, CLK_IGNORE_UNUSED, 0),
	GATE(none, "gate_hclk_ahb2apb_bridge_is3p", "dout_clkdiv_pclk_cam1_busperi_84", \
	...
	GATE(none, "gate_hclk_asyncahbslave_to_blkc", "dout_clkdiv_pclk_cam1_busperi_84", \
			EXYNOS7420_ENABLE_ACLK_CAM11, 10, CLK_IGNORE_UNUSED, 0),
	GATE(none, "gate_hclk_asyncahbslave_to_blkd", "dout_clkdiv_pclk_cam1_busperi_84", \
	...
	GATE(none, "gate_pclk_pmu_cam1", "dout_clkdiv_pclk_cam1_busperi_84", \
			EXYNOS7420_ENABLE_PCLK_CAM12, 1, CLK_IGNORE_UNUSED, 0),
	GATE(gate_sclk_isp_pwm, "gate_sclk_isp_pwm", "dout_clkdiv_pclk_cam1_busperi_84", \
	...
	GATE(none, "gate_clk_133_cam1_noc_p_cam1", "mout_user_mux_aclk_cam1_nocp_133", \
			EXYNOS7420_ENABLE_ACLK_CAM12, 24, CLK_IGNORE_UNUSED, 0),
	GATE(none, "gate_hclks_asyncahb_cam1", "mout_user_mux_aclk_cam1_nocp_133", \
	...
	GATE(none, "gate_aclk_axi2apb_bridge", "dout_clkdiv_pclk_isp0_trex_266", \
			EXYNOS7420_ENABLE_ACLK_ISP00, 14, CLK_IGNORE_UNUSED, 0),
	GATE(none, "gate_aclk_xiu_async_m", "dout_clkdiv_pclk_isp0_trex_266", \
			EXYNOS7420_ENABLE_ACLK_ISP00, 15, CLK_IGNORE_UNUSED, 0),
	GATE(none, "gate_pclk_pmu_isp0", "dout_clkdiv_pclk_isp0_trex_266", \
			EXYNOS7420_ENABLE_PCLK_ISP0, 20, CLK_IGNORE_UNUSED, 0),

	GATE(none, "gate_hclk_ahb2apb_bridge", "dout_clkdiv_pclk_isp0_trex_133", \
	...
	GATE(none, "gate_hclkm_ahb_async_m", "dout_clkdiv_pclk_isp0_trex_133", \
	...
	GATE(none, "gate_aclk_xiu_n_async_mi", "dout_clkdiv_pclk_isp1_isp1_234", \
			EXYNOS7420_ENABLE_ACLK_ISP1, 9, CLK_IGNORE_UNUSED, 0),
	GATE(none, "gate_aclk_axi2apb_bridge_is2p", "dout_clkdiv_pclk_isp1_isp1_234", \
			EXYNOS7420_ENABLE_ACLK_ISP1, 10, CLK_IGNORE_UNUSED, 0),

	GATE(none, "gate_aclk_ahb2apb_bridge_is2p", "mout_user_mux_aclk_isp1_ahb_117", \
			EXYNOS7420_ENABLE_ACLK_ISP1, 11, CLK_IGNORE_UNUSED, 0),
	GATE(none, "gate_hclkm_asyncahbmaster", "mout_user_mux_aclk_isp1_ahb_117", \
			EXYNOS7420_ENABLE_ACLK_ISP1, 12, CLK_IGNORE_UNUSED, 0),
	GATE(none, "gate_pclk_pmu_isp1", "mout_user_mux_aclk_isp1_ahb_117", \
	...
	GATE(gate_aclk_lh_cam0, "gate_aclk_lh_cam0", "usermux_aclk_bus0_532", \
			EXYNOS7420_ENABLE_ACLK_BUS0, 1, CLK_IGNORE_UNUSED, NULL),
	GATE(gate_aclk_lh_cam1, "gate_aclk_lh_cam1", "usermux_aclk_bus0_532", \
			EXYNOS7420_ENABLE_ACLK_BUS0, 2, CLK_IGNORE_UNUSED, NULL),
	GATE(gate_aclk_lh_isp, "gate_aclk_lh_isp", "usermux_aclk_bus0_532", \
			EXYNOS7420_ENABLE_ACLK_BUS0, 8, CLK_IGNORE_UNUSED, NULL),
	...
	GATE(none, "pclk_noc_sfr_bus0", "dout_pclk_bus0_133", \
			EXYNOS7420_ENABLE_PCLK_BUS0, 11, CLK_GATE_ENABLE, NULL),
	GATE(none, "pclk_gpio_bus0", "dout_pclk_bus0_133", \
			EXYNOS7420_ENABLE_PCLK_BUS0, 13, CLK_GATE_ENABLE, NULL),

	/* camera block sysmmus */
	GATE(CLK_ACLK_CAM0_SYSMMU, "aclk_cam0_smmu", "mout_user_mux_aclk_cam0_trex_532", \
			EXYNOS7420_ENABLE_ACLK_CAM01, 0, 0, NULL),
	GATE(CLK_PCLK_CAM0_SYSMMU, "pclk_cam0_smmu", "dout_clkdiv_pclk_cam0_trex_266", \
			EXYNOS7420_ENABLE_PCLK_CAM01, 0, 0, NULL),
	GATE(CLK_ACLK_FIMC_SC_SYSMMU, "aclk_fimc_sc_smmu", "mout_user_mux_aclk_cam1_sclvra_491", \
			EXYNOS7420_ENABLE_ACLK_CAM10, 11, 0, NULL),
	GATE(CLK_PCLK_FIMC_SC_SYSMMU, "pclk_fimc_sc_smmu", "dout_clkdiv_pclk_cam1_busperi_167", \
			EXYNOS7420_ENABLE_PCLK_CAM10, 11, 0, NULL),
	GATE(CLK_ACLK_VRA_SYSMMU, "aclk_vra_smmu", "mout_user_mux_aclk_cam1_sclvra_491", \
			EXYNOS7420_ENABLE_ACLK_CAM10, 12, 0, NULL),
	GATE(CLK_PCLK_VRA_SYSMMU, "pclk_vra_smmu", "dout_clkdiv_pclk_cam1_busperi_167", \
			EXYNOS7420_ENABLE_PCLK_CAM10, 12, 0, NULL),
	GATE(CLK_ACLK_ISPCPU_SYSMMU, "aclk_ispcpu_smmu", "mout_user_mux_aclk_cam1_busperi_334", \
			EXYNOS7420_ENABLE_ACLK_CAM10, 13, 0, NULL),
	GATE(CLK_PCLK_ISPCPU_SYSMMU, "pclk_ispcpu_smmu", "dout_clkdiv_pclk_cam1_busperi_167", \
			EXYNOS7420_ENABLE_PCLK_CAM10, 10, 0, NULL),
	GATE(CLK_ACLK_ISP0_SYSMMU, "aclk_isp0_smmu", "mout_aclk_isp0_isp0_590", \
			EXYNOS7420_ENABLE_ACLK_ISP00, 6, 0, NULL),
	GATE(CLK_PCLK_ISP0_SYSMMU, "pclk_isp0_smmu", "mout_aclk_isp0_trex_532", \
			EXYNOS7420_ENABLE_PCLK_ISP0, 6, 0, NULL),
	GATE(CLK_ACLK_TPU_SYSMMU, "aclk_tpu_smmu", "mout_aclk_isp0_tpu_590", \
			EXYNOS7420_ENABLE_ACLK_ISP00, 7, 0, NULL),
	GATE(CLK_PCLK_TPU_SYSMMU, "pclk_tpu_smmu", "mout_aclk_isp0_trex_532", \
			EXYNOS7420_ENABLE_PCLK_ISP0, 7, 0, NULL),
};
