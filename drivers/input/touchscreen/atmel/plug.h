...
#if (defined(CONFIG_MXT_CAL_T37_WORKAROUND) || defined(CONFIG_MXT_AC_T72_WORKAROUND) || defined(CONFIG_MXT_PROCI_PI_WORKAROUND))
...
#define PL_FUNCTION_FLAG_WAKEUP_GESTURE			(1<<22)
//#define PL_FUNCTION_FLAG_WAKEUP_RENEW			(1<<23)
...
struct plugin_proci{
	...
	*/
	...
	int (*get_diagnostic_data)(void *pl_dev, u8 cmd, u8 page, u8 index, u8 num, void * buf, int interval, int interval_c);
