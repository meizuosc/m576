		...
		struct exynos_platform_fimc_is_module *pdata)
{
	...
	int gpio_reset = 0;
	int gpio_none = 0;
      int gpio_io_en,  gpio_a_en, gpio_d_en= 0;
	BUG_ON(!pdev);
	...
	gpio_a_en = of_get_named_gpio(dnode, "gpio_a_en", 0);
	gpio_d_en = of_get_named_gpio(dnode, "gpio_d_en", 0);
...
//#ifdef CONFIG_MACH_ESPRESSO7420
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_ON, gpio_reset, "sen_rst low", PIN_OUTPUT, 0, 0);
      SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_ON, gpio_io_en, "io_en", PIN_OUTPUT, 1, 0);
      SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_ON, gpio_a_en, "a_en", PIN_OUTPUT, 1, 0);
      SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_ON, gpio_d_en, "d_en", PIN_OUTPUT, 1, 0);
