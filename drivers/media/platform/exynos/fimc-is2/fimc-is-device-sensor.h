...
#define SENSOR_PDAFON_MASK		0x0F000000
#define SENSOR_PDAFON_SHIFT		24
#define SENSOR_MODULE_MASK		0x00FFFFFF
...
enum mz_vcm_driver_ic_id {
	UNDEFINED_VCM_DRIVER_IC,
	VCM_DRIVER_IC_BU63165 = 1,
	VCM_DRIVER_IC_LC898212,
};

struct mz_module_info {
	bool valid;
	enum mz_module_id vendor_id;
	enum mz_vcm_driver_ic_id driver_ic_id;
};
