...
long fimc_is_ssx_video_compat_ioctl(struct file *file,
	       unsigned int cmd, unsigned long arg)
{
	return fimc_is_user_ioctl_handler(file, cmd, arg, (void __user *)arg);
}
#endif
...
#if defined(CONFIG_CAMERA_SUPPORT_PDAF)
#ifdef CONFIG_COMPAT
	.compat_ioctl32 	= fimc_is_ssx_video_compat_ioctl,
#endif
#endif
};
