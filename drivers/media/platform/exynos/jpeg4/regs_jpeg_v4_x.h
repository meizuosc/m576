...
#define S5P_JPEG_HUFF_QUAN_TABLE_DATA_MASK		(1 << S5P_JPEG_HUFF_QUAN_TABLE_DATA_RDY_SHIFT)
#define S5P_JPEG_HUFF_QUAN_TABLE_DATA_NOT_VALID		(0 << S5P_JPEG_HUFF_QUAN_TABLE_DATA_RDY_SHIFT)
#define S5P_JPEG_HUFF_QUAN_TABLE_DATA_VALID		(1 << S5P_JPEG_HUFF_QUAN_TABLE_DATA_RDY_SHIFT)

#define S5P_JPEG_QUAN_TABLE_READ_START_SHIFT		13
#define S5P_JPEG_QUAN_TABLE_READ_DONT_START		(0 << S5P_JPEG_QUAN_TABLE_READ_START_SHIFT)
#define S5P_JPEG_QUAN_TABLE_READ_START			(1 << S5P_JPEG_QUAN_TABLE_READ_START_SHIFT)
