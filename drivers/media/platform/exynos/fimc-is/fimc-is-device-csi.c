...
extern void s5pcsis_enable_interrupts(u32 __iomem *base_reg, struct fimc_is_image *image, bool on);
extern void s5pcsis_set_hsync_settle(u32 __iomem *base_reg, int settle);
extern void s5pcsis_set_params(u32 __iomem *base_reg, struct fimc_is_image *image, u32 lanes);
extern void s5pcsis_reset(u32 __iomem *base_reg);
extern void s5pcsis_system_enable(u32 __iomem *base_reg, int on, u32 lanes);
#endif
