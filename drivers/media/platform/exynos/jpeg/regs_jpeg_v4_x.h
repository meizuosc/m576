...
#define S5P_JPEG_RST_INTERVAL(x) \
		(((x) & 0xffff) << S5P_JPEG_RST_INTERVAL_SHIFT)
...
#define S5P_JPEG_DEC_IMG_RESLN_TYPE_MASK \
		(3 << S5P_JPEG_DEC_IMG_RESLN_TYPE_SHIFT)
#define S5P_JPEG_DEC_IMG_RESLN_TYPE(x) \
		((x) << S5P_JPEG_DEC_IMG_RESLN_TYPE_SHIFT)
...
#define S5P_JPEG_YUV_444_IP_YUV_444_2P_IMG \
		(4 << S5P_JPEG_YUV_444_IP_SHIFT)
#define S5P_JPEG_YUV_444_IP_YUV_444_3P_IMG \
		(5 << S5P_JPEG_YUV_444_IP_SHIFT)
...
#define S5P_JPEG_YUV_422_IP_YUV_422_2P_IMG \
		(5 << S5P_JPEG_YUV_422_IP_SHIFT)
#define S5P_JPEG_YUV_422_IP_YUV_422_3P_IMG \
		(6 << S5P_JPEG_YUV_422_IP_SHIFT)

#define S5P_JPEG_YUV_420_IP_SHIFT		15
#define S5P_JPEG_YUV_420_IP_MASK		(7 << S5P_JPEG_YUV_420_IP_SHIFT)
#define S5P_JPEG_YUV_420_IP_YUV_420_2P_IMG \
		(4 << S5P_JPEG_YUV_420_IP_SHIFT)
#define S5P_JPEG_YUV_420_IP_YUV_420_3P_IMG \
		(5 << S5P_JPEG_YUV_420_IP_SHIFT)

#define S5P_JPEG_YUV_422V_IP_SHIFT		18
#define S5P_JPEG_YUV_422V_IP_MASK \
		(7 << S5P_JPEG_YUV_422V_IP_SHIFT)
#define S5P_JPEG_YUV_422V_IP_YUV_422V_2P_IMG \
		(4 << S5P_JPEG_YUV_422V_IP_SHIFT)
#define S5P_JPEG_YUV_422V_IP_YUV_422V_3P_IMG \
		(5 << S5P_JPEG_YUV_422V_IP_SHIFT)
...
#define S5P_JPEG_RE_ORDER_YUV_422_1P_MASK \
		(3 << S5P_JPEG_RE_ORDER_YUV_422_1P_SHIFT)
#define S5P_JPEG_ENC_FMT_YUYV \
		(0 << S5P_JPEG_RE_ORDER_YUV_422_1P_SHIFT)
#define S5P_JPEG_ENC_FMT_YVYU \
		(1 << S5P_JPEG_RE_ORDER_YUV_422_1P_SHIFT)
#define S5P_JPEG_ENC_FMT_UYVY \
		(2 << S5P_JPEG_RE_ORDER_YUV_422_1P_SHIFT)
#define S5P_JPEG_ENC_FMT_VYUY \
		(3 << S5P_JPEG_RE_ORDER_YUV_422_1P_SHIFT)
...
#define S5P_JPEG_PAD_CB_G(x) \
		(((x) & 0xff) << S5P_JPEG_PAD_CB_G_SHIFT)
#define S5P_JPEG_PAD_CR_B_SHIFT		16
#define S5P_JPEG_PAD_CR_B_MASK		(0xff << S5P_JPEG_PAD_CR_B_SHIFT)
#define S5P_JPEG_PAD_CR_B(x) \
		(((X) & 0xff) << S5P_JPEG_PAD_CR_B_SHIFT)
...
#define S5P_JPEG_IMG_TOP_MARGIN_MASK \
		(0xffff << S5P_JPEG_IMG_TOP_MARGIN_SHIFT)
#define S5P_JPEG_IMG_TOP_MARGIN(x) \
	(((x) << S5P_JPEG_IMG_TOP_MARGIN_SHIFT) & S5P_JPEG_IMG_TOP_MARGIN_MASK)
#define S5P_JPEG_IMG_BOTTOM_MARGIN_SHIFT	16
#define S5P_JPEG_IMG_BOTTOM_MARGIN_MASK \
		(0xffff << S5P_JPEG_IMG_BOTTOM_MARGIN_SHIFT)
#define S5P_JPEG_IMG_BOTTOM_MARGIN(x) \
	(((x) << S5P_JPEG_IMG_BOTTOM_MARGIN_SHIFT) & \
	 S5P_JPEG_IMG_BOTTOM_MARGIN_MASK)

#define S5P_JPEG_IMG_LEFT_MARGIN_SHIFT		0
#define S5P_JPEG_IMG_LEFT_MARGIN_MASK \
		(0xffff << S5P_JPEG_IMG_LEFT_MARGIN_SHIFT)
#define S5P_JPEG_IMG_LEFT_MARGIN(x) \
	(((x) << S5P_JPEG_IMG_LEFT_MARGIN_SHIFT) & \
	 S5P_JPEG_IMG_LEFT_MARGIN_MASK)
#define S5P_JPEG_IMG_RIGHT_MARGIN_SHIFT		16
#define S5P_JPEG_IMG_RIGHT_MARGIN_MASK \
		(0xffff << S5P_JPEG_IMG_RIGHT_MARGIN_SHIFT)
#define S5P_JPEG_IMG_RIGHT_MARGIN(x) \
		(((x) << S5P_JPEG_IMG_RIGHT_MARGIN_SHIFT) & \
		 S5P_JPEG_IMG_RIGHT_MARGIN_MASK)

/* JPEG IP Version */
#define S5P_JPEG_IP_VERSION_SHIFT		0
#define S5P_JPEG_IP_VERSION_MASK \
		(0xffffffff << S5P_JPEG_IP_VERSION_SHIFT)
#define S5P_JPEG_IP_VERSION(x) \
		(((x) & S5P_JPEG_IP_VERSION_MASK) << S5P_JPEG_IP_VERSION_SHIFT)
...
#define S5P_JPEG_NUMBER_OF_COMPONENTS_MASK \
	(0xff << S5P_JPEG_NUMBER_OF_COMPONENTS_SHIFT)
#define S5P_JPEG_NUMBER_OF_COMPONENTS(x) \
	(((x) & 0xff) << S5P_JPEG_NUMBER_OF_COMPONENTS_SHIFT)
...
#define S5P_JPEG_HUFF_QUAN_TABLE_DATA_RDY_SHIFT		12
#define S5P_JPEG_HUFF_QUAN_TABLE_DATA_MASK \
		(1 << S5P_JPEG_HUFF_QUAN_TABLE_DATA_RDY_SHIFT)
#define S5P_JPEG_HUFF_QUAN_TABLE_DATA_NOT_VALID	\
		(0 << S5P_JPEG_HUFF_QUAN_TABLE_DATA_RDY_SHIFT)
#define S5P_JPEG_HUFF_QUAN_TABLE_DATA_VALID \
		(1 << S5P_JPEG_HUFF_QUAN_TABLE_DATA_RDY_SHIFT)

#define S5P_JPEG_QUAN_TABLE_READ_START_SHIFT		13
#define S5P_JPEG_QUAN_TABLE_READ_DONT_START \
		(0 << S5P_JPEG_QUAN_TABLE_READ_START_SHIFT)
#define S5P_JPEG_QUAN_TABLE_READ_START \
		(1 << S5P_JPEG_QUAN_TABLE_READ_START_SHIFT)
