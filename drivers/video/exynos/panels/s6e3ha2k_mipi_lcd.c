...
static int s6e3ha2k_probe(struct mipi_dsim_device *dsim)
{
	dsim_base = dsim;
...
static int s6e3ha2k_init(struct mipi_dsim_device *dsim)
{
...
static int s6e3ha2k_displayon(struct mipi_dsim_device *dsim)
{
	lcd_enable();
	return 1;
}

static int s6e3ha2k_suspend(struct mipi_dsim_device *dsim)
{
	return 0;
}

static int s6e3ha2k_resume(struct mipi_dsim_device *dsim)
{
	return 0;
}
