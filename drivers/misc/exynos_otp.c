...
static const struct otp_struct exynos7420_otp_struct[] = {
	magic_offset(OTP_MAGIC_MIPI_DSI0_M0,  0),
	magic_offset(OTP_MAGIC_MIPI_DSI0_M1, (112 >> 3)),
	magic_offset(OTP_MAGIC_MIPI_CSI0, (224 >> 3)),
	magic_offset(OTP_MAGIC_MIPI_CSI1, (336 >> 3)),
	magic_offset(OTP_MAGIC_MIPI_CSI2, (448 >> 3)),
	magic_offset(OTP_MAGIC_MIPI_CSI3, (560 >> 3)),
	magic_offset(OTP_MAGIC_MPHY_LLI, (768 >> 3)),
	magic_offset(OTP_MAGIC_PCIE_WIFI, (OTP_BANK0_SIZE + 0)),
	magic_offset(OTP_MAGIC_PCIE_MODEM, (OTP_BANK0_SIZE + (256 >> 3))),
	magic_offset(OTP_MAGIC_HDMI, (OTP_BANK0_SIZE + (512 >> 3))),
	magic_offset(OTP_MAGIC_EDP, (OTP_BANK0_SIZE + (768 >> 3))),
};
...
static int __init otp_early_init(void)
{
	...
	if (soc_is_exynos7420()) {
		tune_bits_size = OTP_BANK0_SIZE + OTP_BANK1_SIZE;
		nr_ipblk = ARRAY_SIZE(exynos7420_otp_struct);
		exynos_otp_struct = (struct otp_struct *)exynos7420_otp_struct;
	} else {
		goto out;
	}
