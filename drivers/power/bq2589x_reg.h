...
#define BQ2589X_VINDPMOS_BASE       2600
...
enum temp_range{
	SONY_FREEZE_TEMP = 1, //-20 < t < 0
	SONY_COLD_TEMP = 2,//0<= t < 10
	SONY_ROOM_TEMP = 3,//10<= t< 15
	SONY_WARM_TEMP = 4,//15 <=t <= 45
	SONY_HOT_TEMP = 5,//45 < t <= 55
	SONY_ALARM_TEMP = 6,// 55 <t <=60


	ATL_FREEZE_TEMP = 7, //-20 < t < 0
	ATL_COLD_TEMP = 8,//0<= t < 10
	ATL_ROOM_TEMP = 9,//10<= t< 25
	ATL_WARM_TEMP = 10,//25 <= t <= 45
	ATL_HOT_TEMP = 11,//45 < t <= 55
	ATL_ALARM_TEMP = 12,// 55 <t <=60

	BOARD_HOT_TEMP = 13, //42c
	BOARD_COLD_TEMP = 14, //38c
};
