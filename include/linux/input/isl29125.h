...
#define ALS_TAG  "[isl29125]:"
#define isl_log(fmt, args...)    printk(ALS_TAG fmt, ##args)
...
#define WHITE_HIGH_LUX_COEF	9040
#define BLACK_HIGH_LUX_COEF	16399
#define WHITE_LOW_LUX_COEF	339
#define BLACK_LOW_LUX_COEF	615

#define DEFAULT_CONVERSION_TIME	400 // ms
/*
enum work_status { 
